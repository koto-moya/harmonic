...
class Ui_mw_home(object):
    def setupUi(self, mw_home):
        ...
        self.cb_existingcodes.setGeometry(QRect(510, 80, 103, 32))
        ...
        self.bt_submitnewcode_2 = QPushButton(self.page)
        self.bt_submitnewcode_2.setObjectName(u"bt_submitnewcode_2")
        self.bt_submitnewcode_2.setGeometry(QRect(510, 220, 100, 32))
        ...
        self.bt_submitnewcode_3 = QPushButton(self.page)
        self.bt_submitnewcode_3.setObjectName(u"bt_submitnewcode_3")
        self.bt_submitnewcode_3.setGeometry(QRect(470, 420, 121, 32))
        self.stackedWidget.addWidget(self.page)
        self.page_2 = QWidget()
        self.page_2.setObjectName(u"page_2")
        self.comboBox = QComboBox(self.page_2)
        self.comboBox.setObjectName(u"comboBox")
        self.comboBox.setGeometry(QRect(60, 70, 103, 32))
        self.cb_spendgoalpodcast = QComboBox(self.page_2)
        self.cb_spendgoalpodcast.setObjectName(u"cb_spendgoalpodcast")
        self.cb_spendgoalpodcast.setGeometry(QRect(60, 150, 103, 32))
        ...
        self.cb_actualspendbrand = QComboBox(self.page_2)
        self.cb_actualspendbrand.setObjectName(u"cb_actualspendbrand")
        self.cb_actualspendbrand.setGeometry(QRect(500, 70, 103, 32))
        self.label_5 = QLabel(self.page_2)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(510, 120, 58, 16))
        self.cb_actualspendpodcast = QComboBox(self.page_2)
        self.cb_actualspendpodcast.setObjectName(u"cb_actualspendpodcast")
        self.cb_actualspendpodcast.setGeometry(QRect(500, 150, 103, 32))
    ...
    def retranslateUi(self, mw_home):
        ...
        self.bt_submitnewcode_2.setText(QCoreApplication.translate("mw_home", u"suspend code", None))
        self.lbl_newcode_3.setText(QCoreApplication.translate("mw_home", u"new podcast", None))
        self.bt_submitnewcode_3.setText(QCoreApplication.translate("mw_home", u"submit podcast", None))
